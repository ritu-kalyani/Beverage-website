...
?>
    ...
    <div class="Register-form">
        ...
        <form method ="post">
          ...
          <div class="Register-field">
            <input type="password" placeholder="create your password" name="registerPassword" autocomplete="on" required>
          </div>
          <div class="Register-field">
            <input type="password" placeholder="Confirm your password" name="registerCPassword" autocomplete="on" required>
          </div>
